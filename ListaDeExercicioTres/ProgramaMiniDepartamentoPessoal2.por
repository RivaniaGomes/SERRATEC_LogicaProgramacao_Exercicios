...
programa {
	inclua biblioteca Matematica --> mat
		const real horaPadrao = 160.0 
		cadeia nomeFuncionario
		real horaExtra, salarioBase, salarioBruto, salarioLiquido, descontoInss, percentualDesconto, valorHora, valorHoraExtra
	...
	funcao calculos() {
		salarioBase = horaPadrao * valorHora
		valorHoraExtra = (horaExtra * valorHora) * 1.5
		salarioBruto = (horaPadrao * valorHora) + valorHoraExtra
	...
	funcao contraCheque() {
		...
		pulaLinha()
		espacamento()
		escreva("Salário base............: ", mat.arredondar(salarioBase, 2))
		pulaLinha()
		espacamento()
		escreva("Valor das horas extras..: ", mat.arredondar(valorHoraExtra, 2))
		pulaLinha()
		espacamento()
